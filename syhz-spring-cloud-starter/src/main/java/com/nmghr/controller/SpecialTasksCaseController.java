...
@RestController
@RequestMapping("/specialtaskcase")
public class SpecialTasksCaseController {
	...
	public Object list(@RequestBody Map<String, Object> requestBody) throws Exception {
		LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "REPORTCASETOTAL");
	...
	public Object pageByCid(@RequestBody Map<String, Object> requestBody) throws Exception {
		...
		LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "SPECIALTASKCASE");
