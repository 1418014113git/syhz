...
@RestController
@RequestMapping("/inegmapp")
public class InegMappingController {
	...
	public Object list(@RequestBody Map<String, Object> requestBody) throws Exception {
		LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "INEGMAPPCOUNT");
	...
	public Object pageByCid(@RequestBody Map<String, Object> requestBody) throws Exception {
		...
		LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "INEGMAPPBYCID");
