  ...
  public void initDate(Map<String, Object> map,Map<String, Object> obj,int count) {
    if(null != obj) {
      ...
      count = Integer.valueOf(obj.get("chengqu")+"") +Integer.valueOf(obj.get("jiaoqu")+"") + 
              Integer.valueOf(obj.get("zheng")+"")+Integer.valueOf(obj.get("chengqu")+"") + 
              Integer.valueOf(obj.get("xiangcun")+"")+Integer.valueOf(obj.get("linqu")+"")+
              Integer.valueOf(obj.get("other")+"");
    }else {
      map.put("chengqu", 0);
      map.put("jiaoqu", 0);
      map.put("zheng", 0);
