...
public class PersonMessageQueryHandler extends AbstractQueryHandler {
  ...
  public Object list(Map<String, Object> requestBody) throws Exception {
    ...
    List<Map<String, Object>> jqzyzt = new ArrayList<Map<String, Object>>();
    List<Map<String, Object>> qbxsfkzt = new ArrayList<Map<String, Object>>();
    List<Map<String, Object>> jqzyxflb = new ArrayList<Map<String, Object>>();
    ...
    List<Map<String, Object>> qbxsjl = new ArrayList<Map<String, Object>>();
    ...
    for (int i = 0; i < list.size(); i++) {
      if ("mz".equals(String.valueOf(list.get(i).get("codeLx")))) {
        ...
        cjlx.add(list.get(i));
      } else if ("jqzyzt".equals(String.valueOf(list.get(i).get("codeLx")))) {
        jqzyzt.add(list.get(i));
      } else if ("qbxsfkzt".equals(String.valueOf(list.get(i).get("codeLx")))) {
        qbxsfkzt.add(list.get(i));
      } else if ("jqzyxflb".equals(String.valueOf(list.get(i).get("codeLx")))) {
        jqzyxflb.add(list.get(i));
      } else if ("fllb".equals(String.valueOf(list.get(i).get("codeLx")))) {
        fllb.add(list.get(i));
      } else if ("qbxsffzt".equals(String.valueOf(list.get(i).get("codeLx")))) {
        ...
        xsly.add(list.get(i));
      } else if ("qbxsjl".equals(String.valueOf(list.get(i).get("codeLx")))) {
        qbxsjl.add(list.get(i));
      }
    }
    ...
    map.put("xsfl", xsfl);
    map.put("cjlx", cjlx);
    map.put("jqzyzt", jqzyzt);
    map.put("qbxsfkzt", qbxsfkzt);
    map.put("jqzyxflb", jqzyxflb);
    map.put("fllb", fllb);
