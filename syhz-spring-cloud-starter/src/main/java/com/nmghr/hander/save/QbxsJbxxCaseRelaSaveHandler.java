...
@Service("qbxsjbxxcaserelaSaveHandler")
public class QbxsJbxxCaseRelaSaveHandler extends AbstractSaveHandler {

  public QbxsJbxxCaseRelaSaveHandler(IBaseService baseService) {
    super(baseService);
  ...
  public Object save(Map<String, Object> requestBody) throws Exception {
    ...
    // 清空
    LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "INVESTIGATIONMAPPING");// QBXSJBXXCASE
    ...
    for (Iterator iterator = caseIds.iterator(); iterator.hasNext();) {
      ...
      LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "INVESTIGATIONMAPPING");//统一防止LocalTread 被修改
