...
public class ClueSaveHandler extends AbstractSaveHandler {
    ...
    public Object save(Map<String, Object> body) throws Exception {
        ...
        body.put("clueTime", StringUtils.isEmpty(body.get("clueTime").toString()) ? null : new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(String.valueOf(body.get("clueTime")))); // 发生时间
