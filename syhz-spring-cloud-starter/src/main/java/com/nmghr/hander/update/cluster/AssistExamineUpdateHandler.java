...
@Service("assistExamineUpdateHandler")
public class AssistExamineUpdateHandler extends AbstractUpdateHandler {

  public AssistExamineUpdateHandler(IBaseService baseService) {
    super(baseService);
  }
...
//      }
   ...
   * @throws Exception
   */
  private void updateAssist(String noticeId, int status, Map<String, Object> body) throws Exception {
