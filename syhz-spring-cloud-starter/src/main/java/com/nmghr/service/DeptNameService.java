...
public class DeptNameService implements IBaseService {
  ...
  public Object list(Map<String, Object> requestMap) throws Exception {
    ...
    if("receiveList".equals(String.valueOf(requestMap.get("queryType")))){
      return userExtMapper.getUserList(requestMap);
    }
    if("managerUserList".equals(String.valueOf(requestMap.get("queryType")))){
      return userExtMapper.getManagerUserList(requestMap);
    }
    return new ArrayList();
  }
