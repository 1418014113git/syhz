...
public class AppVerifyUtils {
	...
	public static void verifyOperationParams(OperationRequestVo operationRequestVo) {
		verifyCommonParam(operationRequestVo.getJsonrpc(), operationRequestVo.getMethod(), operationRequestVo.getId());
	 ...
	 * @param queryRequestVo
	 */
	public static void getQueryCondition(Map<String, Object> conditionMap, QueryRequestVo queryRequestVo) {
		...
		if (condition != null && !"".equals(condition)) {
			if (condition.indexOf("and") >= 0) {
				...
				for (String conditionStr : conditionArr) {
					...
					if (conditionDataArr.length > 1) {
						conditionMap.put(conditionDataArr[0], conditionDataArr[1]);
					} else {
						conditionMap.put(conditionDataArr[0], "");
					}
				}
			} else {
				String conditionData = condition.replaceAll(" ", "").replaceAll("'", "");
				String[] conditionDataArr = conditionData.split("=");
				conditionMap.put(conditionDataArr[0], conditionDataArr[1]);
			}
		}
	 ...
	 * @param queryRequestVo
	 */
	public static Page getQueryPage(QueryRequestVo queryRequestVo) {
		return queryRequestVo.getParams().getData().getPage();
	}
	 ...
	 * @param queryRequestVo
	 */
	public static String getQuerySourceId(QueryRequestVo queryRequestVo) {
		return queryRequestVo.getParams().getData().getSource().getSourceId();
	}
	 ...
	 * @param queryRequestVo
	 */
	public static String getQuerySign(QueryRequestVo queryRequestVo) {
		return queryRequestVo.getParams().getSign();
	}

	public static String getOperateDataObjId(OperationRequestVo operationRequestVo) {
		return operationRequestVo.getParams().getData().getOperations().get(0).getDataObjId();
	}

	public static String getQueryDataObjId(QueryRequestVo queryRequestVo) {
		return queryRequestVo.getParams().getData().getDataObjId();
	}
	 ...
	 * @param operationRequestVo
	 */
	public static void getOperationCondition(Map<String, Object> operationMap, OperationRequestVo operationRequestVo) {
