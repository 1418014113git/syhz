...
public class TrainWorkorderExamineService {
  ...
  public Object examineWorkFlowData(IBaseService baseService, Map<String, String> headers,
    ...
    if (workflowExamineEntityBo != null) {
      return saveWorkorder(baseService, workflowExamineEntityBo);
    } else {
      return "";
    }
  }
   ...
   * @return
   */
  private WorkflowExamineEntityBo verifyData(Map<String, String> headers,
      Map<String, Object> requestBody) throws GlobalErrorException {
    ...
    WorkflowExamineEntityBo workflowExamineEntityBo =
        WorkflowExamineEntityBo.workflowExamineMapToEntityBo(headers, requestBody);
    return workflowExamineEntityBo;
  }

  private Object saveWorkorder(IBaseService baseService,
      WorkflowExamineEntityBo workflowExamineEntityBo) throws Exception {
  ...
  private void AuditSuccess(IBaseService baseService,
      WorkflowExamineEntityBo workflowExamineEntityBo, Map<String, Object> workHeaderMap,
      Map<String, Object> workNodeMap) throws Exception {
    Map<String, Object> workorderExamineMap = new HashMap<String, Object>();
    // 获取下有审核工作流转
    ...
    if ("0".equals(nextFlowId)) { // 如果 下一级流转是0 则说明审核为最终审批 需修改主体表审核状态为 2审核通过 审核节点表状态为2 对应文章表审核状态为2
      ...
      workHeaderDataMap.put("currentAuditAreaCode", workflowExamineEntityBo.getDeptCode());
      workHeaderDataMap.put("currentAuditDepCode", workflowExamineEntityBo.getDeptAreaCode());
      ...
      String belongMode = SyhzUtil.setDate(workHeaderMap.get("belongMode")); // 所属模块(知识库包含：1 法律法规、2行业标准、3规则制度、4案例指引 网上培训：1在线课程
    ...
    // 审核通过记录 添加
    folwLogSaveData(baseService, workflowExamineEntityBo, workNodeMap.get("auditDeptNode"),
        AUDIT_STATUS_2);
  }
   ...
   * @throws Exception
   */
  private void upWorkHeaderData(IBaseService baseService, String workId,
   ...
   * @throws Exception
   */
  private void upWorkNodeData(IBaseService baseService, String workNodeId,
      Map<String, Object> dataMap) throws Exception {
   ...
   * @throws Exception
   */
  private void upArticleData(IBaseService baseService, String articleId,
      Map<String, Object> dataMap) throws Exception {
   ...
   * @throws Exception
   */
  private void folwLogSaveData(IBaseService baseService,
      WorkflowExamineEntityBo workflowExamineEntityBo, Object auditDeptNode, Object auditStatus)
      throws Exception {
  ...
  private Map<String, Object> getWorkHeader(IBaseService baseService,
      Map<String, Object> workorderExamineMap) throws Exception {
    LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, ALIAS_TRAIN_WORK);
   ...
   */
  @SuppressWarnings("unchecked")
  private Map<String, Object> getWorkNode(IBaseService baseService,
      Map<String, Object> workorderExamineMap) throws Exception {
    LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, ALIAS_TRAIN_WORK_FLOW);
