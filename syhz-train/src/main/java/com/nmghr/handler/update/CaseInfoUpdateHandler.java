...
@Service("caseinfoUpdateHandler")
public class CaseInfoUpdateHandler extends AbstractUpdateHandler {
	@Autowired
	private EnclosureAuditService EnclosureAuditService;
	private static String ALIAS_TRAININDUSTRYINFO = "TRAINCASEINFO";// 行业标准
	...
	public CaseInfoUpdateHandler(IBaseService baseService) {
		super(baseService);
	}
