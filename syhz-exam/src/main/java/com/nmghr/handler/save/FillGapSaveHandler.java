...
@Service("fillgapSaveHandler")
public class FillGapSaveHandler extends AbstractSaveHandler {
    public FillGapSaveHandler(IBaseService baseService) {
        super(baseService);
    }
